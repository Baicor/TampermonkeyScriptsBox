...
// @version      0.2
// @description  进入某些网站时自动关闭弹窗；关闭google ads
// @author       Galio
// @include      *
...
var hostMap = {
    ...
    'www.jianshu.com': 'button._23ISFX-close'
}

var removeElement = ["[class*='adsbygoogle']"]
...
function closeByRemove(){
    removeElement.forEach((el) => {
        let els = findElements(el)
        els.forEach((element) => {
            element.remove()
        })
    })
